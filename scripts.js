...
// Função para adicionar automático os valores base das raças
document.getElementById("race").addEventListener("change", function() {
    var selectedRace = this.value;

    if (selectedRace === "Humano") {
        document.getElementById("max-health").value = 8;
        document.getElementById("max-stamina").value = 7;
        document.getElementById("intellect-bonus").value = 1;
        document.getElementById("agility-bonus").value = 1;
        document.getElementById("touch-current").value = 1;
    } else if (selectedRace === "Elfos") {
        document.getElementById("max-health").value = 6;
        document.getElementById("max-stamina").value = 10;
        document.getElementById("intellect-bonus").value = 2;
        document.getElementById("vision-current").value = 2;
        document.getElementById("hearing-current").value = 1;
    } else if (selectedRace === "Orcs") {
        document.getElementById("max-health").value = 10;
        document.getElementById("max-stamina").value = 5;
        document.getElementById("strength-bonus").value = 2;
        document.getElementById("vision-current").value = 1;
        document.getElementById("touch-current").value = 2;
    } else if (selectedRace === "Goblins") {
        document.getElementById("max-health").value = 5;
        document.getElementById("max-stamina").value = 5;
        document.getElementById("agility-bonus").value = 3;
        document.getElementById("vision-current").value = 1;
        document.getElementById("hearing-current").value = 2;
        document.getElementById("touch-current").value = 2;
    } else {
        // Reseta os valores se outra raça for selecionada
        document.getElementById("max-health").value = '';
        document.getElementById("max-stamina").value = '';
        document.getElementById("intellect-bonus").value = '';
        document.getElementById("agility-bonus").value = '';
        document.getElementById("strength-bonus").value = '';
        document.getElementById("vision-current").value = '';
        document.getElementById("hearing-current").value = '';
        document.getElementById("touch-current").value = '';
    }

    // Atualiza o SG após mudança de raça
    updateSG();
});
